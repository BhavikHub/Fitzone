...
const Workout = () => {
  return (
    ...
    <img src= {process.env.PUBLIC_URL +"/Images/Strength.png"} className="card-img-top" alt="..." />
  ...
  <div className="card mx-3 my-3 cards" style={{ width: '18rem', boxShadow: "#241a1a 8px 8px 10px" }}>
    <img src={process.env.PUBLIC_URL + "/Images/Cardio.png"} className="card-img-top" alt="..." />
    <div className="card-body card-color">
  ...
  <div className="card mx-3 my-3 cards" style={{ width: '18rem', boxShadow: "#241a1a 8px 8px 10px" }}>
    <img src={process.env.PUBLIC_URL + "/Images/Crossfit.png"} className="card-img-top" alt="..." />
    <div className="card-body card-color">
  ...
  <div className="card mx-3 my-3 cards" style={{ width: '18rem', boxShadow: "#241a1a 8px 8px 10px" }}>
    <img src={process.env.PUBLIC_URL + "/Images/Zumba.png"} className="card-img-top" alt="..." />
    <div className="card-body card-color">
